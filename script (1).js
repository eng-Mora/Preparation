        ...
        sorted.forEach((v,i) => {
            ...
            if (urls.length > 1) {
                urls.forEach((url,j) => {
                    ...
                    html += `<div class="video-wrapper"><iframe src="${url}" frameborder="0" allow="autoplay *; fullscreen *; picture-in-picture *" allowfullscreen webkitallowfullscreen mozallowfullscreen referrerpolicy="no-referrer-when-downgrade"></iframe></div>`;
                });
            } else {
                html += `<div class="video-wrapper"><iframe src="${urls[0]||''}" frameborder="0" allow="autoplay *; fullscreen *; picture-in-picture *" allowfullscreen webkitallowfullscreen mozallowfullscreen referrerpolicy="no-referrer-when-downgrade"></iframe></div>`;
            }
            html += '</div>';
        });
